...
import { Eye, Users, MessageSquare, TrendingUp, ArrowUpRight, FileText, MapPin, Briefcase, GraduationCap, Award, } from "lucide-react";
          ...
          <Card className="lg:col-span-1 bg-card border-border">
            ...
            <CardContent className="space-y-6">
              <div className="flex flex-col items-center text-center">
                ...
                {profile.location && (<div className="flex items-center gap-1 text-muted-foreground text-sm mt-1">
              ...
              {profile.skills && profile.skills.length > 0 && (<div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {profile.skills.slice(0, 4).map((skill, index) => (<Badge key={index} variant="secondary" className="text-xs">
                        {skill}
                      </Badge>))}
                    {profile.skills.length > 4 && (<Badge variant="outline" className="text-xs">
              ...
              <div className="flex gap-2">
                ...
                <Link to="/profile/public" className="flex-1">
            ...
            <Card className="bg-card border-border">
              ...
              <CardContent>
                <div className="space-y-4">
                  {recentActivity.map((activity, index) => (<div key={index} className="flex items-center justify-between p-3 rounded-lg bg-secondary/50 border border-border">
                ...
                : activity.type === "save"
                    ...
                    : "bg-chart-3/10 text-chart-3"}`}>
                          {activity.type === "view" ? (<Eye className="h-4 w-4"/>) : activity.type === "save" ? (<Users className="h-4 w-4"/>) : (<MessageSquare className="h-4 w-4"/>)}
                        </div>
                        <div>
