      ...
      <div className="space-y-6 max-w-4xl">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex gap-2">
            <Button variant="outline" onClick={() => router.push("/profile/public")} className="bg-transparent">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setFormData({ ...formData, category: value, jobRole: "" })}
                    >
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        {(jobRoles[formData.category] || []).map((role) => (
                ...
                {formData.skills.length > 0 && (
                  <div className="flex flex-wrap gap-2">
                    {formData.skills.map((skill, index) => (
                      <Badge key={index} variant="secondary" className="pl-3 pr-1 py-1.5 gap-1">
                        {skill}
                        <button
              ...
              <CardContent className="space-y-6">
                {formData.projects.length === 0 ? (
                  ...
                  formData.projects.map((project, index) => (
                    <div key={project.id} className="p-4 rounded-lg bg-secondary/50 border border-border space-y-4">
                      <div className="flex items-start justify-between">
